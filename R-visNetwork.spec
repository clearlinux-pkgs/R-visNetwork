...
License  : MIT
Requires: R-visNetwork-license = %{version}-%{release}
...
%package license
Summary: license components for the R-visNetwork package.
Group: Default

%description license
license components for the R-visNetwork package.


%prep
%setup -q -n visNetwork
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664560394

%install
export SOURCE_DATE_EPOCH=1664560394
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/package-licenses/R-visNetwork
cp %{_builddir}/visNetwork/inst/NOTICE %{buildroot}/usr/share/package-licenses/R-visNetwork/3e59f7c3778ab14c2ca2b9a3730b1495c2ba166c || :
cp %{_builddir}/visNetwork/inst/htmlwidgets/lib/export/Blob/LICENSE.md %{buildroot}/usr/share/package-licenses/R-visNetwork/6738bf0bfe9b153d2e4a7379f51b18ca6a5022b1 || :
cp %{_builddir}/visNetwork/inst/htmlwidgets/lib/export/FileSaver/LICENSE.md %{buildroot}/usr/share/package-licenses/R-visNetwork/9843a153b38281f3eebda0b30ec73a6675e0d770 || :
cp %{_builddir}/visNetwork/inst/htmlwidgets/lib/export/canvas-toBlob/LICENSE.md %{buildroot}/usr/share/package-licenses/R-visNetwork/bb503e5bcfe70057b5029f11bf1d0fb48802d7f3 || :
cp %{_builddir}/visNetwork/inst/htmlwidgets/lib/ionicons/LICENSE %{buildroot}/usr/share/package-licenses/R-visNetwork/c73e73874bcfde08d57da0a1b9fbb7842acfb9c7 || :
export LANG=C.UTF-8
...
/usr/share/package-licenses/R-visNetwork/3e59f7c3778ab14c2ca2b9a3730b1495c2ba166c
/usr/share/package-licenses/R-visNetwork/6738bf0bfe9b153d2e4a7379f51b18ca6a5022b1
/usr/share/package-licenses/R-visNetwork/9843a153b38281f3eebda0b30ec73a6675e0d770
/usr/share/package-licenses/R-visNetwork/bb503e5bcfe70057b5029f11bf1d0fb48802d7f3
/usr/share/package-licenses/R-visNetwork/c73e73874bcfde08d57da0a1b9fbb7842acfb9c7
