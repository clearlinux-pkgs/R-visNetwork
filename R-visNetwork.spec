...
Version  : 2.0.8
Release  : 26
URL      : https://cran.r-project.org/src/contrib/visNetwork_2.0.8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/visNetwork_2.0.8.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567569338
